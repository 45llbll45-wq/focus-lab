      ...
      <div className="space-y-3 flex-1">
        {filteredIdeas.length === 0 ? (
          <div className="bg-white border-2 border-dashed border-slate-200 rounded-3xl p-8 text-center space-y-3">
            ...
            <div className="space-y-1">
              <h3 className="font-bold text-slate-700 text-sm">لا توجد أفكار بعد في هذا القسم</h3>
              ...
              >
                ...
                {idea.taskTitle && (
                  <div className="text-[11px] text-slate-400 font-medium">
                    المصدر: <span className="text-slate-600 font-semibold">{idea.taskTitle}</span>
                  </div>
                )}
                ...
                {isExpanded && (
                  <div className="bg-slate-50 border border-slate-200/80 rounded-xl p-3 text-xs text-slate-800 whitespace-pre-line leading-relaxed font-sans">
                    {idea.body}
                  </div>
                )}
